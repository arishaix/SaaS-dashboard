...
const AddRevenueForm: React.FC<AddRevenueFormProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80">
      <div className="bg-[#16113a] rounded-2xl shadow-lg p-14 w-full max-w-2xl relative border-2 border-white">
        <button
        ...
        <h2 className="text-3xl font-bold mb-12 text-white">Add Revenue</h2>
